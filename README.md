...
| [`pdf-annotator/`](./pdf-annotator/) | ✍️ **Mark up a PDF, send notes back to Claude** — opens an AI-made PDF in a self-contained PDF.js viewer where you underline any word/phrase and attach a note. Press ✓ and the notes POST straight back through a one-shot localhost server (written next to the PDF); Claude picks them up automatically and revises the source. No saving, works offline. |
